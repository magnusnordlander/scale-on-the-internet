...
#define MENU_SCROLL_DEAD_TIME_MICROS 0
#define MENU_SCROLL_DOUBLE_SCROLL_DEAD_TIME_MICROS 0
#define MENU_SCROLL_DEAD_TIME_DIRECTION_SWITCH 0
#define MENU_DOUBLE_SCROLL_THRESHOLD 0
